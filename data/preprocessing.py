from trading.indicators import calculate_rsi, kdj, calculate_atr
import numpy as np
...
def dat_preprocess(dat_in):
    ...
    dat['rsi_14'], dat['stoch_rsi'] = calculate_rsi(dat.close, period=14, stoch_period=14)
